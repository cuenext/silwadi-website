(function attachSilwadiLanguage(root, factory) {
  ...
  const arabic = {
    ...
    'Specialist Prosthodontist and Implantologist': 'اختصاصي تركيبات وزراعة الأسنان',
    'Abu Dhabi': 'أبوظبي',
    ...
    'Google': 'Google',
    'Read reviews on Google Maps →': 'اقرأ التقييمات على خرائط Google ←',
    'Read the full reviews on Google Maps.': 'اقرأ التقييمات كاملةً على خرائط Google.',
