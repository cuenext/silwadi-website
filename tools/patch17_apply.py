...
old = old.replace(
    '<span class="footer-logo-crop"><img src="assets/silwadi-logo-official.png" alt="Silwadi Dental Center"></span>',
    '<img class="site-footer-logo home-trust-footer-logo" src="assets/silwadi-logo-official.png" alt="Silwadi Dental Center" width="600" height="600" loading="lazy" decoding="async">'
)
...
.home-trust-footer-logo{display:block;width:116px;height:96px;object-fit:contain;margin:0 0 16px}
...
@media(max-width:760px){.home-trust-brand{width:84px;height:64px}.home-trust-footer-logo{width:100px;height:84px}.home-google-reviews{padding:70px 0 76px}.home-google-reviews__head{grid-template-columns:1fr;gap:22px;margin-bottom:28px}.google-rating-card{max-width:290px}.google-review-card{width:280px;min-height:202px;padding:20px}}
